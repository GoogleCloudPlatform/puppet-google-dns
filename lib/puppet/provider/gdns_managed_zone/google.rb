...
Puppet::Type.type(:gdns_managed_zone).provide(:google) do
  ...
  def self.fetch_to_hash(fetch)
    {
      description: Google::Dns::Property::String.parse(fetch['description']),
      dns_name: Google::Dns::Property::String.parse(fetch['dnsName']),
      id: Google::Dns::Property::Integer.parse(fetch['id']),
      name: Google::Dns::Property::String.parse(fetch['name']),
      name_servers:
        Google::Dns::Property::StringArray.parse(fetch['nameServers']),
      name_server_set:
        Google::Dns::Property::StringArray.parse(fetch['nameServerSet']),
      creation_time: Google::Dns::Property::Time.parse(fetch['creationTime'])
    }.reject { |_, v| v.nil? }
  end
  ...
  def create
    ...
    create_req = Google::Dns::Network::Post.new(collection(@resource),
                                                ...
                                                'application/json',
                                                resource_to_request)
    @fetched = return_if_object create_req.send, 'dns#managedZone'
    @property_hash[:ensure] = :present
  end
