...
describe Puppet::Type.type(:gdns_managed_zone).provider(:google) do
  before(:all) do
          ...
          context 'title == name (pass)' do
            ...
            context 'Gdns_managed_zone[title0]' do
              ...
              it do
                is_expected
                  .to have_attributes(
                    creation_time: '2059-01-15T02:08:23+00:00'
                  )
              end
            end
            ...
            context 'Gdns_managed_zone[title1]' do
              ...
              it do
                is_expected
                  .to have_attributes(
                    creation_time: '2148-01-30T04:16:47+00:00'
                  )
              end
            end
            ...
            context 'Gdns_managed_zone[title2]' do
              ...
              it do
                is_expected
                  .to have_attributes(
                    creation_time: '2237-02-13T06:25:11+00:00'
                  )
              end
            end
          end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_compiled_manifest(
              ...
              MANIFEST
            ).catalog.resource('Gdns_managed_zone[title0]').provider.ensure
          end
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          subject do
            ...
            MANIFEST
            ).catalog.resource('Gdns_managed_zone[title0]')
              .provider.ensure
          end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:gdns_managed_zone).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end
  ...
  def create_type(id)
    Puppet::Type.type(:gdns_managed_zone).new(
      ...
      project: MZ_PROJECT_DATA[(id - 1) % MZ_PROJECT_DATA.size],
      name: MZ_NAME_DATA[(id - 1) % MZ_NAME_DATA.size]
    )
  end
