...
#       puppet apply .tools/end2end/data/delete_resource_record_set.pp
#
...
gdns_managed_zone { 'puppet-e2e-testzone-4-com':
  ensure      => present,
  name        => 'testzone-4-com',
...
gdns_resource_record_set { 'puppet-e2e-www.testzone-4.com.':
  ensure       => absent,
  managed_zone => 'puppet-e2e-testzone-4-com',
  type         => 'A',
  project      => $project, # e.g. 'my-test-project'
  credential   => 'mycred',
}

gdns_resource_record_set { 'puppet-e2e-sites.testzone-4.com.':
  ensure       => absent,
  managed_zone => 'puppet-e2e-testzone-4-com',
  type         => 'CNAME',
  project      => $project, # e.g. 'my-test-project'
...
gdns_resource_record_set { 'puppet-e2e-deleteme.testzone-4.com.':
  ensure       => absent,
  managed_zone => 'puppet-e2e-testzone-4-com',
  type         => 'A',
  project      => $project, # e.g. 'my-test-project'
